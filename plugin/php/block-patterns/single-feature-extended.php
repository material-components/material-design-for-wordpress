...
<div class="wp-block-material-image-list" id="block-material-image-list-1"><ul class="mdc-image-list mdc-image-list--with-text-protection"><li class="mdc-image-list__item"><a class="mdc-image-list__item-wrap" href="https://materialdesign.test/wp-content/plugins/material-design/assets/images/placeholder.png"><div class="mdc-image-list__image-aspect-container"><img class="mdc-image-list__image" alt="" src="' . $image . '" data-link="' . $image . '"/></div></a></li><li class="mdc-image-list__item"><a class="mdc-image-list__item-wrap" href="' . $image . '"><div class="mdc-image-list__image-aspect-container"><img class="mdc-image-list__image" alt="" src="' . $image . '" data-link="' . $image . '"/></div></a></li><li class="mdc-image-list__item"><a class="mdc-image-list__item-wrap" href="' . $image . '"><div class="mdc-image-list__image-aspect-container"><img class="mdc-image-list__image" alt="" src="' . $image . '" data-link="' . $image . '"/></div></a></li><li class="mdc-image-list__item"><a class="mdc-image-list__item-wrap" href="' . $image . '"><div class="mdc-image-list__image-aspect-container"><img class="mdc-image-list__image" alt="" src="' . $image . '" data-link="' . $image . '"/></div></a></li></ul></div>
...
<!-- wp:material/buttons -->
<div class="wp-block-material-buttons"><!-- wp:material/button {"style":"elevated","elevationStyle":"filled"} -->
<div class="wp-block-material-button" id="block-material-button-7"><button class="mdc-button label-large mdc-button--filled"><i class="material-icons mdc-button__icon">spa</i><div class="mdc-button__ripple"></div><span class="mdc-button__label">Call to action</span></button></div>

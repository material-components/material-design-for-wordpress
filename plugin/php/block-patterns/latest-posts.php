...
return [
	...
	'content'       => '<!-- wp:columns {"verticalAlignment":"center","align":"wide"} --><div class="wp-block-columns alignwide are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"66.66%"} --><div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.66%"><!-- wp:heading {"level":4} --><h4>Latest Posts</h4><!-- /wp:heading --><!-- wp:paragraph --><p>Perform this action in no time. Satisfaction guaranteed</p><!-- /wp:paragraph --></div><!-- /wp:column --><!-- wp:column {"verticalAlignment":"center","width":"33.33%"} --><div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33.33%"><!-- wp:material/buttons {"align":"right"} --><div class="wp-block-material-buttons alignright"><!-- wp:material/button {"iconPosition":"none","size":"large","style":"elevated"} --><div class="wp-block-material-button" id="block-material-button-59"><button class="mdc-button label-large mdc-button--elevated is-large"><div class="mdc-button__ripple"></div><span class="mdc-button__label">Get Started</span></button></div><!-- /wp:material/button --></div><!-- /wp:material/buttons --></div><!-- /wp:column --></div><!-- /wp:columns --><!-- wp:material/recent-posts {"contentLayout":"text-under-media","postsToShow":3,"displayCommentsCount":false} /-->',
	'viewportWidth' => 800,

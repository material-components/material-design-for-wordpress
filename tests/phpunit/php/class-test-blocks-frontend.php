	...
	public static function generate_fixtures( $factory ) {
		self::$post_id = $factory->post->create(
			[
				...
				<!-- wp:material/button {"label":"Submit","style":"unelevated","cornerRadius":4,"icon":{"name":"spa","hex":59517},"isSubmit":true} -->

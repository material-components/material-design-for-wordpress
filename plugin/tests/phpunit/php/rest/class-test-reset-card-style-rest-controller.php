...
<div class="wp-block-material-cards-collection alignwide" id="block-material-cards-collection-1"><div class="masonry-grid layout-masonry"><div style="width:50%" class="masonry-grid_column"><div class="card-container"><div class="mdc-card material-design-card"><div class="mdc-card__primary-action material-design-card__primary-action mdc-ripple-upgraded" tabindex="0"><div tabindex="0" class="mdc-card__media mdc-card__media--16-9 material-design-card__media material-design-card-with-text-under-media"><img src="http://localhost:8088/wp-content/uploads/2021/04/material-demo-photo-1558906217-200fade11db0.jpeg" alt="Title card"/></div><div class="material-design-card__primary"><h2 class="material-design-card__title mdc-typography mdc-typography--headline6">Title card</h2><h3 class="material-design-card__secondary-text mdc-typography mdc-typography--subtitle2">Title card</h3></div><div class="material-design-card__supporting-text material-design-card__supporting-text_text-under-media mdc-typography mdc-typography--body2">Title card</div></div><div class="mdc-card__actions"><div class="mdc-card__action-buttons"><a href="#" class="mdc-button mdc-card__action mdc-card__action--button"><div class="mdc-button__ripple"></div><span class="mdc-button__label">btn</span></a></div></div></div></div></div><div style="width:50%" class="masonry-grid_column"><div class="card-container"><div class="mdc-card material-design-card"><div class="mdc-card__primary-action material-design-card__primary-action mdc-ripple-upgraded" tabindex="0"><div tabindex="0" class="mdc-card__media mdc-card__media--16-9 material-design-card__media material-design-card-with-text-under-media"><img src="http://localhost:8088/wp-content/uploads/2021/04/material-demo-photo-1558906217-021abc4ab788.jpeg" alt="Title card"/></div><div class="material-design-card__primary"><h2 class="material-design-card__title mdc-typography mdc-typography--headline6">Title card</h2><h3 class="material-design-card__secondary-text mdc-typography mdc-typography--subtitle2">Title card</h3></div><div class="material-design-card__supporting-text material-design-card__supporting-text_text-under-media mdc-typography mdc-typography--body2">Title card</div></div><div class="mdc-card__actions"><div class="mdc-card__action-buttons"><a href="#" class="mdc-button mdc-card__action mdc-card__action--button"><div class="mdc-button__ripple"></div><span class="mdc-button__label">btn</span></a></div></div></div></div></div></div></div>
...
<div class="wp-block-material-card"><div class="mdc-card mdc-card--outlined material-design-card"><div class="mdc-card__primary-action material-design-card__primary-action mdc-ripple-upgraded" tabindex="0"><div tabindex="0" class="mdc-card__media mdc-card__media--16-9 material-design-card__media material-design-card-with-text-under-media"><img src="http://localhost:8088/wp-content/uploads/2021/04/material-demo-photo-1558906217-200fade11db0.jpeg" alt="card"/></div><div class="material-design-card__primary"><h2 class="material-design-card__title mdc-typography mdc-typography--headline6">card</h2><h3 class="material-design-card__secondary-text mdc-typography mdc-typography--subtitle2">card</h3></div><div class="material-design-card__supporting-text material-design-card__supporting-text_text-under-media mdc-typography mdc-typography--body2">card</div></div><div class="mdc-card__actions"><div class="mdc-card__action-buttons"><a href="#" class="mdc-button mdc-card__action mdc-card__action--button"><div class="mdc-button__ripple"></div><span class="mdc-button__label">BTN</span></a></div></div></div></div>
<!-- /wp:material/card -->',
			]
		);

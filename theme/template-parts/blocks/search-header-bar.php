...
/**
 * Search button and search form for top app bar in header.
 */
$wrapper_attributes = get_block_wrapper_attributes( [ 'class' => 'material-icons mdc-top-app-bar__navigation-icon mdc-icon-button search__button mdc-ripple-upgraded--unbounded mdc-ripple-upgraded' ] );

...
unset( $_plugins, $_plugin_candidate, $_plugin_file_candidate, $_plugin_file_src ); //phpcs:ignore WordPressVIPMinimum.Variables.VariableAnalysis.UndefinedUnsetVariable
